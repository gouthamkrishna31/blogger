...
const (
	BlogService_CreatePost_FullMethodName = "/bloggging.BlogService/CreatePost"
	BlogService_ReadPost_FullMethodName   = "/bloggging.BlogService/ReadPost"
	BlogService_UpdatePost_FullMethodName = "/bloggging.BlogService/UpdatePost"
	BlogService_DeletePost_FullMethodName = "/bloggging.BlogService/DeletePost"
)
...
type BlogServiceClient interface {
	...
	ReadPost(ctx context.Context, in *GetPostRequest, opts ...grpc.CallOption) (*GetPostResponse, error)
...
func (c *blogServiceClient) ReadPost(ctx context.Context, in *GetPostRequest, opts ...grpc.CallOption) (*GetPostResponse, error) {
...
type BlogServiceServer interface {
	...
	ReadPost(context.Context, *GetPostRequest) (*GetPostResponse, error)
...
func (UnimplementedBlogServiceServer) ReadPost(context.Context, *GetPostRequest) (*GetPostResponse, error) {
...
func _BlogService_ReadPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).ReadPost(ctx, req.(*GetPostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bloggging.BlogService",
